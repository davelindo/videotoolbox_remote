...
extern const FFCodec ff_h264_videotoolbox_remote_decoder;
extern const FFCodec ff_h264_videotoolbox_remote_encoder;
...
extern const FFCodec ff_hevc_videotoolbox_remote_decoder;
extern const FFCodec ff_hevc_videotoolbox_remote_encoder;
