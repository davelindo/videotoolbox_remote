...
### Changed
- Rebased the vendored `ffmpeg/` subtree to upstream `master` snapshot `b139ba11d8e8` (from `6246f7a4cde6`).

## [v0.9.4] - 2026-09-25

### Changed
- Rebased the vendored `ffmpeg/` subtree to upstream `master` snapshot `6246f7a4cde6` (from `c0e8b139fd32`).

## [v0.9.3] - 2026-09-24

### Changed
- Rebased the vendored `ffmpeg/` subtree to upstream `master` snapshot `c0e8b139fd32` (from `dc5242441917`).
...
### Changed
- Rebased the vendored `ffmpeg/` subtree to upstream `master` snapshot `8b34c36e61ed` (from `1f9ba3fb6b19`).
...
### Changed
- Rebased the vendored `ffmpeg/` subtree to upstream `master` snapshot `22b96de8034f` (from `903325e279b6`).

## [v0.8.5] - 2026-09-09

### Changed
- Rebased the vendored `ffmpeg/` subtree to upstream `master` snapshot `903325e279b6` (from `35b7df64a014`).

## [v0.8.4] - 2026-09-08

### Changed
- Rebased the vendored `ffmpeg/` subtree to upstream `master` snapshot `35b7df64a014` (from `ecc7eb519ec8`).

## [v0.8.3] - 2026-09-07

### Changed
- Rebased the vendored `ffmpeg/` subtree to upstream `master` snapshot `ecc7eb519ec8` (from `f93cd72dde30`).
